...
## Notes
- Added `quoteTime`, `tradeTime`, greeks, and IV provenance (`iv_source`) to Alpaca snapshot rows.
- Snapshot `meta.json` now records Alpaca provider params (feeds + recent bars buffer minutes).
