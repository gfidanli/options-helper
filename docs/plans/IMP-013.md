# IMP-013 — Quote staleness + data quality scoring
...
- Compute a per-contract `quote_quality` object:
  ...
  - `score` (0–100) and `label` (`good/ok/bad/unknown`)
- Bubble up summary stats:
  - % contracts with missing bid/ask
  - worst/median spread_pct
  - count of stale quotes
- Make it easy for downstream outputs to say “this is low-confidence data”.
...
- Start at 100
- If missing bid/ask → score = min(score, 40) and label at most `ok`
...
## Implementation plan
### Step 1 — Centralize in a new module
**Files:**
...
### Step 2 — Wire into roll-plan + research
**Files:**
...
### Step 3 — Wire into analyze/advice
**Files:**
...
### Step 4 — Surface in snapshot meta + briefing (optional)
**Files:**
