...
|---:|---|---|---|:---:|:---:|
| 1 | IMP-001 | Spread-aware contract selection everywhere ([IMP-001](./IMP-001.md)) | ready | S | High |
| 2 | IMP-012 | Earnings-aware event risk warnings + DTE gating ([IMP-012](./IMP-012.md)) | ready | S | High |
