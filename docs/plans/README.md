...
| 11 | IMP-007 | Options backtester using snapshot history (daily) ([IMP-007](./IMP-007.md)) | done | L | Very High |
| 12 | IMP-009 | Data-provider abstraction (swap Yahoo for better data) ([IMP-009](./IMP-009.md)) | done | L | Very High |
...
| 17 | IMP-030 | Repo cleanup: modular CLI + regression tests (no behavior changes) ([IMP-030](./IMP-030.md)) | draft | M–L | Medium |
