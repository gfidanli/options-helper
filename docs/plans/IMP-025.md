...
## Completion notes
- Option bars are fetched in batches and merged into chain rows (`volume`, `vwap`, `trade_count`).
- Snapshotter now passes `snapshot_date` through to providers that accept it.
