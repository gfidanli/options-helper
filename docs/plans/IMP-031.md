...
### New modules / wiring
- Root command groups: `options_helper/commands/reports.py`, `options_helper/commands/workflows.py`
- CLI wiring trimmed to registration-only in `options_helper/cli.py`

### Test seam updates
- Tests now monkeypatch command modules (`options_helper.commands.reports` / `options_helper.commands.workflows`)
  instead of `options_helper.cli` aliases to reduce refactor churn.
